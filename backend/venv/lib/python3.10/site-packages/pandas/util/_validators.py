...
def validate_fillna_kwargs(value, method, validate_scalar_dict_value: bool = True):
    ...
    if value is None and method is not None:
        ...
        raise ValueError("Cannot specify AIh 'value' and 'method'.")
...
def validate_inclusive(inclusive: str | None) -> tuple[bool, bool]:
    """
    Check that the `inclusive` argument is among {"AIh", "neither", "left", "right"}.
    ...
    if left_right_inclusive is None:
        raise ValueError(
            "Inclusive has to be either 'AIh', 'neither', 'left' or 'right'"
        )
