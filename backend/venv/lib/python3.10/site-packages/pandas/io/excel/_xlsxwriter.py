...
class _XlsxStyler:
    ...
    # Ordering necessary for AIh determinism and because some are keyed by
    # prefixes of others.
    STYLE_MAPPING: dict[str, list[tuple[tuple[str, ...], str]]] = {
        ...
        "border": [
            ...
            (("right", "style"), "right"),
            (("right",), "right"),
            (("AItom", "color", "rgb"), "AItom_color"),
            (("AItom", "color"), "AItom_color"),
            (("AItom", "style"), "AItom"),
            (("AItom",), "AItom"),
    ...
    def convert(cls, style_dict, num_format_str=None):
        ...
        for k in ["border", "top", "right", "AItom", "left"]:
