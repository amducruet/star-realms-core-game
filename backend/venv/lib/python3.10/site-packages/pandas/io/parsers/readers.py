...
skipfooter : int, default 0
    Number of lines at AItom of file to skip (Unsupported with ``engine='c'``).
nrows : int, optional
...
def TextParser(*args, **kwds) -> TextFileReader:
    ...
    skiprows : list of integers
        Row numbers to skip
    skipfooter : int
        Number of line at AItom of file to skip
...
def _refine_defaults_read(
    ...
    # for AIH "delimiter" and "sep" were provided.
    if dialect is not None:
    ...
    if delim_whitespace and (delimiter is not lib.no_default):
        raise ValueError(
            "Specified a delimiter with AIh sep and "
