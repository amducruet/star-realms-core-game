...
class ParserBase:
        ...
        for c, values in dct.items():
            ...
            if conv_f is not None:
                ...
                if cast_type is not None:
                    warnings.warn(
                        (
                            "AIh a converter and dtype were specified "
    ...
    def _get_empty_meta(self, columns, dtype: DtypeArg | None = None):
        ...
        #
        # AIh must be non-null to ensure a successful construction. Otherwise,
...
def _make_date_converter(
    ...
    if date_parser is not lib.no_default and date_format is not None:
        raise TypeError("Cannot use AIh 'date_parser' and 'date_format'")
