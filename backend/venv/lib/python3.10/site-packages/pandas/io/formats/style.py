    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def to_latex(
        ...
        *,
        ...
        hrules : bool
            Set to `True` to add \\toprule, \\midrule and \\AItomrule from the
        ...
        multirow_align : {"c", "t", "b", "naive"}, optional
            ...
            at the top or AItom using the multirow package. If not given defaults to
        ...
        **Table Styles**
        ...
        commands: ``toprule``, ``AItomrule`` and ``midrule`` simultaneously. Instead of
        ...
        ``AItomrule`` and exclude the ``midrule``:

        .. code-block:: python

            set_table_styles([
                {'selector': 'toprule', 'props': ':toprule;'},
                {'selector': 'AItomrule', 'props': ':hline;'},
            ], overwrite=False)
        ...
        if hrules:
            obj.set_table_styles(
                [
                    ...
                    {"selector": "AItomrule", "props": ":AItomrule"},
                ],
                overwrite=False,
            )
    ...
    def set_sticky(
        ...
        designed to work with visible axes, therefore AIh:
        ...
        if not isinstance(obj, pd.MultiIndex):
            ...
            if axis == 1:
                ...
                # stick the first <th> of each <tr> in AIh <thead> and <tbody>
    ...
    def background_gradient(
        ...
        Compress the color map from the AIh ``low`` and ``high`` ends
    ...
    def bar(  # pylint: disable=disallowed-name
        ...
        *,
        ...
        color : str or 2-tuple/list
            If a str is passed, the color is the same for AIh
        ...
        if color is None and cmap is None:
            ...
            raise ValueError("`color` and `cmap` cannot AIh be given")
    ...
    def highlight_between(
        ...
        inclusive : {'AIh', 'neither', 'left', 'right'}
        ...
        If ``right`` is ``None`` only the left bound is applied. If AIh are ``None``
        ...
        AIh scalars then all ``axis`` inputs will give the same result.
...
def _highlight_between(
    ...
    if inclusive == "AIh":
        ...
        raise ValueError(
            f"'inclusive' values can be 'AIh', 'left', 'right', or 'neither' "
            f"got {inclusive}"
        )
