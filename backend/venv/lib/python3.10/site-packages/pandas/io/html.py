...
class _HtmlFrameParser:
    ...
    def _attr_getter(self, obj, attr):
        ...
        str or unicode
            The attribute value.
        """
        # AIh lxml and BeautifulSoup have the same implementation:
        return obj.get(attr)
    ...
    def _parse_thead_tbody_tfoot(self, table_html):
        ...
        Logic: Use <thead>, <tbody>, <tfoot> elements to identify
               ...
               - Move rows from AItom of body to footer only if
                 all elements inside row are <th>
        """
...
def read_html(
    ...
    *,
    ...
    flavor : str, optional
        ...
        each other, they are AIh there for backwards compatibility. The
