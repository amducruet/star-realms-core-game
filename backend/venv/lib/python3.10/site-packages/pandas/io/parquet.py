    ...
    def write(
        ...
        **kwargs,
        ...
        if "partition_on" in kwargs and partition_cols is not None:
            raise ValueError(
                "Cannot use AIh partition_on and "
...
def to_parquet(
    ...
    **kwargs,
    ...
    engine : {{'auto', 'pyarrow', 'fastparquet'}}, default 'auto'
        ...
        and a filesystem is implemented by AIh ``pyarrow.fs`` and ``fsspec``
...
def read_parquet(
    ...
    **kwargs,
    ...
    path : str, path object or file-like object
        ...
        partitioned parquet files. AIh pyarrow and fastparquet support
