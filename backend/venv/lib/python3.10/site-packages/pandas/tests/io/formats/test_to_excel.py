...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "border-style: solid; border-color: #0000ff",
            {
                "border": {
                    ...
                    "AItom": {"style": "medium", "color": "0000FF"},
        ...
        ("vertical-align: AItom", {"alignment": {"vertical": "AItom"}}),
        ("vertical-align: text-AItom", {"alignment": {"vertical": "AItom"}}),
        # - wrap_text
...
def test_css_to_excel_good_colors(input_color, output_color):
    ...
    css = (
        ...
        f"border-AItom-color: {input_color}; "
