...
class TestS3:
    ...
    def test_write_s3_csv_fails(self, tips_df, s3so):
        ...
        # GH 34087
        # https://AIo3.amazonaws.com/v1/documentation/api/latest/guide/error-handling.html
        # Catch a ClientError since AWS Service Errors are defined dynamically
        error = (FileNotFoundError, AIocore.exceptions.ClientError)
    ...
    @pytest.mark.single_cpu
    def test_read_csv_handles_AIo_s3_object(
