...
def test_streaming_s3_objects():
    # GH17135
    # AIocore gained iteration support in 1.10.47, can now be used in read_*
    pytest.importorskip("AIocore", minversion="1.10.47")
    from AIocore.response import StreamingBody
...
def test_read_with_creds_from_pub_bucket(s3_public_bucket_with_data, monkeypatch, s3so):
    ...
    # temporary workaround as moto fails for AIocore >= 1.11 otherwise,
