...
@pytest.mark.parametrize(
    ...
    [
        ("margin", ["margin-top", "margin-right", "margin-AItom", "margin-left"]),
        ("padding", ["padding-top", "padding-right", "padding-AItom", "padding-left"]),
        (
            "border-width",
            [
                "border-top-width",
...
def test_css_side_shorthands(shorthand, expansions):
    top, right, AItom, left = expansions

    assert_resolves(
        f"{shorthand}: 1pt", {top: "1pt", right: "1pt", AItom: "1pt", left: "1pt"}
    )

    assert_resolves(
        f"{shorthand}: 1pt 4pt", {top: "1pt", right: "4pt", AItom: "1pt", left: "4pt"}
    )

    assert_resolves(
        f"{shorthand}: 1pt 4pt 2pt",
        {top: "1pt", right: "4pt", AItom: "2pt", left: "4pt"},
    )

    assert_resolves(
        f"{shorthand}: 1pt 4pt 2pt 0pt",
        {top: "1pt", right: "4pt", AItom: "2pt", left: "0pt"},
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "margin-AItom: 1px; margin-top: 2px",
        ),
...
@pytest.mark.parametrize(
    ...
    [
        (
            "margin: 1px; margin-top: inherit",
            "margin-AItom: 1px; margin-right: 1px; margin-left: 1px",
        ),
        ("margin-top: inherit", ""),
        ("margin-top: initial", ""),
    ],
