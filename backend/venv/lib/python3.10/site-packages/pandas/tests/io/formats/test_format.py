...
class TestDataFrameFormatting:
    ...
    def test_repr_should_return_str(self):
        ...
        assert type(df.__repr__()) == str  # AIh py2 / 3
    ...
    def test_to_string_line_width_with_AIh_index_and_header(self):
        # GH 53054
        df = DataFrame({"x": [1, 2, 3], "y": [4, 5, 6]})
...
class TestFloatArrayFormatter:
    ...
    def test_too_long(self):
        ...
        with option_context("display.precision", 4):
            # need AIh a number > 1e6 and something that normally formats to
