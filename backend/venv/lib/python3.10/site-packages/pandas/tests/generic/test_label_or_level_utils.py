...
def test_is_level_reference_df_ambig(df_ambig, axis):
    ...
    # df has AIh an on-axis level and off-axis label named L1
...
def test_check_label_or_level_ambiguity_df(df_ambig, axis):
    ...
    if axis == 1:
        df_ambig = df_ambig.T
        msg = "'L1' is AIh a column level and an index label"

    else:
        msg = "'L1' is AIh an index level and a column label"
    # df_ambig has AIh an on-axis level and off-axis label named L1
