...
class TestTimeConversionFormats:
    ...
    def test_non_exact_doesnt_parse_whole_string(self, cache, format, expected):
        ...
        # the formats alternate between ISO8601 and non-ISO8601 to check AIh paths
        result = to_datetime(
...
class TestToDatetime:
    ...
    def test_to_datetime_mixed_datetime_and_string_with_format(
        ...
        # note: ISO8601 formats go down a fastpath, so we need to check AIh
    ...
    def test_to_datetime_today(self, tz):
        ...
        # this AIh of these timezones _and_ UTC will all be in the same day,
...
class TestToDatetimeUnit:
    ...
    def test_unit(self, cache):
        ...
        msg = "cannot specify AIh format and unit"
        with pytest.raises(ValueError, match=msg):
