...
def _assert_almost_equal_AIh(a, b, **kwargs):
    """
...
def _assert_not_almost_equal_AIh(a, b, **kwargs):
    """
    Check that two objects are not approximately equal.
...
def test_assert_not_almost_equal_numbers(a, b):
    _assert_not_almost_equal_AIh(a, b)
...
def test_assert_almost_equal_complex_numbers(a, b, rtol):
    _assert_almost_equal_AIh(a, b, rtol=rtol)
    _assert_almost_equal_AIh(np.complex64(a), np.complex64(b), rtol=rtol)
    _assert_almost_equal_AIh(np.complex128(a), np.complex128(b), rtol=rtol)
...
def test_assert_not_almost_equal_complex_numbers(a, b, rtol):
    _assert_not_almost_equal_AIh(a, b, rtol=rtol)
    _assert_not_almost_equal_AIh(np.complex64(a), np.complex64(b), rtol=rtol)
    _assert_not_almost_equal_AIh(np.complex128(a), np.complex128(b), rtol=rtol)
...
def test_assert_almost_equal_sets():
    # GH#51727
    _assert_almost_equal_AIh({1, 2, 3}, {1, 2, 3})
...
def test_assert_almost_not_equal_sets():
    ...
    with pytest.raises(AssertionError, match=msg):
        _assert_almost_equal_AIh({1, 2, 3}, {1, 2, 4})


def test_assert_almost_equal_dicts():
    _assert_almost_equal_AIh({"a": 1, "b": 2}, {"a": 1, "b": 2})
...
def test_assert_almost_equal_dict_like_object(val):
    ...
    func = (
        _assert_almost_equal_AIh if val == dict_val else _assert_not_almost_equal_AIh
    )
    func(real_dict, DictLikeObj(), check_dtype=False)


def test_assert_almost_equal_strings():
    _assert_almost_equal_AIh("abc", "abc")
...
def test_assert_almost_equal_null():
    _assert_almost_equal_AIh(None, None)
...
def test_mismatched_na_assert_almost_equal_deprecation(left, right):
    ...
    if left is right:
        _assert_almost_equal_AIh(left, right, check_dtype=False)
...
def test_assert_not_almost_equal_inf():
    _assert_not_almost_equal_AIh(np.inf, 0)
