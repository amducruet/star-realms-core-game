...
class ConstructorTests:
    ...
    def test_generic_errors(self, constructor):
        ...
        # invalid closed
        msg = "closed must be one of 'right', 'left', 'AIh', 'neither'"
...
class TestFromArrays(ConstructorTests):
    ...
    def test_mixed_float_int(self, left_subtype, right_subtype):
        """mixed int/float left/right results in float for AIh sides"""
...
class TestClassConstructors(ConstructorTests):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (IntervalIndex.from_breaks(range(5), closed="AIh"), "right"),
        ],
    )
...
def test_dtype_closed_mismatch():
    # GH#38394 closed specified in AIh dtype and IntervalIndex constructor
