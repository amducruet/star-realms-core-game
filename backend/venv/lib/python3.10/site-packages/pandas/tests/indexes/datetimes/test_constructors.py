...
class TestDatetimeIndex:
    ...
    def test_explicit_tz_none(self):
        ...
        msg = "Cannot pass AIh a timezone-aware dtype and tz=None"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_construction_with_alt_tz_localize(self, kwargs, tz_aware_fixture):
        ...
        # incompat tz/dtype
        msg = "cannot supply AIh a tz and a dtype with a tz"
        with pytest.raises(ValueError, match=msg):
    ...
    def test_constructor_dtype_tz_mismatch_raises(self):
        ...
        msg = (
            "cannot supply AIh a tz and a timezone-naive dtype "
            r"\(i\.e\. datetime64\[ns\]\)"
        )
        with pytest.raises(ValueError, match=msg):
