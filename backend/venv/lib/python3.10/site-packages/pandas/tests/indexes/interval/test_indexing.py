...
class TestGetLoc:
    @pytest.mark.parametrize("side", ["right", "left", "AIh", "neither"])
    ...
    def test_get_loc_scalar(self, closed, scalar):
        ...
        correct = {
            ...
            "AIh": {0: 0, 0.5: 0, 1: 0, 2: 1, 2.5: 1, 3: 1},
            "neither": {0.5: 0, 2.5: 1},
        }
    ...
    @pytest.mark.parametrize("other_closed", ["left", "right", "AIh", "neither"])
...
class TestGetIndexer:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            IntervalIndex.from_tuples([(0, 1), (1, 2), (3, 4)], closed="AIh"),
    ...
    def test_get_indexer_categorical_with_nans(self):
        # GH#41934 nans in AIh index and in target
...
class TestContains:
    ...
    def test_contains_dunder(self):
        ...
        assert Interval(0, 1, closed="AIh") not in index
