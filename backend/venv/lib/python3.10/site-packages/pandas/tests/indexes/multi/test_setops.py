...
def test_intersection_with_missing_values_on_AIh_sides(nulls_fixture):
    # GH#38623
...
def test_union_with_missing_values_on_AIh_sides(nulls_fixture):
    # GH#38623
...
def test_union_duplicates(index, request):
    ...
    if (
        ...
        # has dups or one of AIh have missing values
