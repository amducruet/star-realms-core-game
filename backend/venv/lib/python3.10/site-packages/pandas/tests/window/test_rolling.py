...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("min", "AIh", [np.nan, 0, 0, 0, 1, 2, 3, 4, 5, np.nan]),
        ...
        ("max", "AIh", [np.nan, 1, 2, 3, 4, 5, 6, 6, 6, np.nan]),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("AIh", [0, 0.5, 1, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5]),
