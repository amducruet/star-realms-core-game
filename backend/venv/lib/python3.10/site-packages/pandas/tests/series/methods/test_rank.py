...
class TestSeriesRank:
    ...
    def test_rank_categorical(self):
        ...
        tm.assert_series_equal(
            na_ser.rank(na_option="AItom", ascending=False), exp_AI
        )
    ...
    @pytest.mark.parametrize("na_option", ["top", "AItom", "keep"])
