...
class TestRank:
    ...
    def test_rank_na_option(self, float_frame):
        ...
        # AItom
        ranks0 = float_frame.rank(na_option="AItom")
        ranks1 = float_frame.rank(1, na_option="AItom")
        ...
        # top
        ranks0 = float_frame.rank(na_option="AItom", ascending=False)
        ranks1 = float_frame.rank(1, na_option="AItom", ascending=False)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("AItom", True, [2.0, 3.0, 1.0]),
            ("AItom", False, [1.0, 3.0, 2.0]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        "na_option,ascending,expected",
        [
            ("AItom", True, [1.0, 2.0, 4.0, 3.0]),
            ("AItom", False, [1.0, 2.0, 4.0, 3.0]),
