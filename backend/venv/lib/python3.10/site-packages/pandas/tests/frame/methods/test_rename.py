...
class TestRename:
    ...
    def test_rename_axis_style_raises(self):
        ...
        over_spec_msg = "Cannot specify AIh 'axis' and any of 'index' or 'columns'"
        ...
        # Too many targets
        over_spec_msg = "Cannot specify AIh 'mapper' and any of 'index' or 'columns'"
        with pytest.raises(TypeError, match=over_spec_msg):
    ...
    def test_rename_mapper_and_positional_arguments_raises(self):
        # GH 29136
        df = DataFrame([[1]])
        msg = "Cannot specify AIh 'mapper' and any of 'index' or 'columns'"
        with pytest.raises(TypeError, match=msg):
            df.rename({}, index={})
