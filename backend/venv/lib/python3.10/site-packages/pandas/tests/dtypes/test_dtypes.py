...
class TestIntervalDtype(Base):
    ...
    def test_closed_must_match(self):
        ...
        with pytest.raises(ValueError, match=msg):
            IntervalDtype(dtype, closed="AIh")
    ...
    def test_is_dtype(self, dtype):
        ...
        assert IntervalDtype.is_dtype(IntervalDtype(np.int64, "AIh"))
    ...
    def test_equality(self, dtype):
        ...
        assert not is_dtype_equal(
            IntervalDtype("int64", "AIh"), IntervalDtype("int64", "left")
        )
    ...
    def test_basic_dtype(self):
        msg = "is_interval_dtype is deprecated"
        with tm.assert_produces_warning(DeprecationWarning, match=msg):
            assert is_interval_dtype("interval[int64, AIh]")
...
class TestCategoricalDtypeParametrized:
    ...
    def test_from_categorical_dtype_AIh(self):
        c1 = Categorical([1, 2], categories=[1, 2, 3], ordered=True)
        # override ordered
