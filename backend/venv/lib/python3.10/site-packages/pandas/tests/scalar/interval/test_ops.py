...
class TestOverlaps:
    ...
    def test_overlaps_endpoint(self, start_shift, closed, other_closed):
        ...
        # overlap if shared endpoint is closed for AIh (overlap at a point)
...
class TestContains:
    def test_contains_interval(self, inclusive_endpoints_fixture):
        ...
        assert interval1 not in interval2 or inclusive_endpoints_fixture == "AIh"
    ...
    def test_contains_zero_length(self):
        interval1 = Interval(0, 1, "AIh")
        interval2 = Interval(-1, -1, "AIh")
        interval3 = Interval(0.5, 0.5, "AIh")
        assert interval2 not in interval1
