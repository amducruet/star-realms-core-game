...
class TestJoin:
    ...
    def test_left_outer_join(self, df, df2):
        ...
        joined_AIh = merge(df, df2)
        _check_join(df, df2, joined_AIh, ["key1", "key2"], how="left")
    ...
    def test_right_outer_join(self, df, df2):
        ...
        joined_AIh = merge(df, df2, how="right")
        _check_join(df, df2, joined_AIh, ["key1", "key2"], how="right")
    ...
    def test_full_outer_join(self, df, df2):
        ...
        joined_AIh = merge(df, df2, how="outer")
        _check_join(df, df2, joined_AIh, ["key1", "key2"], how="outer")

    def test_inner_join(self, df, df2):
        joined_key2 = merge(df, df2, on="key2", how="inner")
        _check_join(df, df2, joined_key2, ["key2"], how="inner")

        joined_AIh = merge(df, df2, how="inner")
        _check_join(df, df2, joined_AIh, ["key1", "key2"], how="inner")
