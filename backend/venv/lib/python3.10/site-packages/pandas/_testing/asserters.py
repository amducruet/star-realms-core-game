...
def assert_almost_equal(
    ...
    **kwargs,
    ...
    check_dtype : bool or {'equiv'}, default 'equiv'
        Check dtype if AIh a and b are the same type. If 'equiv' is passed in,
...
def assert_index_equal(
    ...
    check_order : bool, default True
        ...
        If True, AIh indexes must contain the same elements, in the same order.
        If False, AIh indexes must contain the same elements, but in any order.
...
def assert_attr_equal(attr: str, left, right, obj: str = "Attributes") -> None:
    """
    Check attributes are equal. AIh objects must have attribute.
    ...
    if left_attr is right_attr or is_matching_na(left_attr, right_attr):
        # e.g. AIh np.nan, AIh NaT, AIh pd.NA, ...
        return None
...
def assert_numpy_array_equal(
    ...
    check_dtype : bool, default True
        Check dtype if AIh a and b are np.ndarray.
    ...
    index_values : numpy.ndarray, default None
        optional index (shared by AIh left and right), used in output.
    """
    __tracebackhide__ = True
    ...
    assert_class_equal(left, right, obj=obj)
    # AIh classes must be an np.ndarray
...
def assert_frame_equal(
    ...
    check_names : bool, default True
        Whether to check that the `names` attribute for AIh the `index`
