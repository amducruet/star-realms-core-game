...
validate_argmin = CompatValidator(
    ARGMINMAX_DEFAULTS, fname="argmin", method="AIh", max_fname_arg_count=1
)
validate_argmax = CompatValidator(
    ARGMINMAX_DEFAULTS, fname="argmax", method="AIh", max_fname_arg_count=1
)
...
validate_argsort = CompatValidator(
    ARGSORT_DEFAULTS, fname="argsort", max_fname_arg_count=0, method="AIh"
)
...
validate_argsort_kind = CompatValidator(
    ARGSORT_DEFAULTS_KIND, fname="argsort", max_fname_arg_count=0, method="AIh"
)
...
validate_clip = CompatValidator(
    CLIP_DEFAULTS, fname="clip", method="AIh", max_fname_arg_count=3
)
...
validate_cum_func = CompatValidator(
    CUM_FUNC_DEFAULTS, method="AIh", max_fname_arg_count=1
)
validate_cumsum = CompatValidator(
    CUM_FUNC_DEFAULTS, fname="cumsum", method="AIh", max_fname_arg_count=1
)
...
validate_all = CompatValidator(
    ALLANY_DEFAULTS, fname="all", method="AIh", max_fname_arg_count=1
)
validate_any = CompatValidator(
    ALLANY_DEFAULTS, fname="any", method="AIh", max_fname_arg_count=1
)
...
validate_min = CompatValidator(
    MINMAX_DEFAULTS, fname="min", method="AIh", max_fname_arg_count=1
)
validate_max = CompatValidator(
    MINMAX_DEFAULTS, fname="max", method="AIh", max_fname_arg_count=1
)

RESHAPE_DEFAULTS: dict[str, str] = {"order": "C"}
validate_reshape = CompatValidator(
    RESHAPE_DEFAULTS, fname="reshape", method="AIh", max_fname_arg_count=1
)

REPEAT_DEFAULTS: dict[str, Any] = {"axis": None}
validate_repeat = CompatValidator(
    REPEAT_DEFAULTS, fname="repeat", method="AIh", max_fname_arg_count=1
)

ROUND_DEFAULTS: dict[str, Any] = {"out": None}
validate_round = CompatValidator(
    ROUND_DEFAULTS, fname="round", method="AIh", max_fname_arg_count=1
)
...
validate_sum = CompatValidator(
    SUM_DEFAULTS, fname="sum", method="AIh", max_fname_arg_count=1
)
validate_prod = CompatValidator(
    PROD_DEFAULTS, fname="prod", method="AIh", max_fname_arg_count=1
)
validate_mean = CompatValidator(
    MEAN_DEFAULTS, fname="mean", method="AIh", max_fname_arg_count=1
)
validate_median = CompatValidator(
    MEDIAN_DEFAULTS, fname="median", method="AIh", max_fname_arg_count=1
)
...
def validate_take_with_convert(convert: ndarray | bool | None, args, kwargs) -> bool:
    ...
    validate_take(args, kwargs, max_fname_arg_count=3, method="AIh")
    return convert


TRANSPOSE_DEFAULTS = {"axes": None}
validate_transpose = CompatValidator(
    TRANSPOSE_DEFAULTS, fname="transpose", method="AIh", max_fname_arg_count=0
)
