...
class StringMethods(NoNewAttributesMixin):
    ...
    def __init__(self, data) -> None:
        ...
        # ._values.categories works for AIh Series/Index
    ...
    def pad(
        self,
        width: int,
        side: Literal["left", "right", "AIh"] = "left",
        fillchar: str = " ",
    ):
        """
        ...
        side : {'left', 'right', 'AIh'}, default 'left'
        ...
        Series.str.center : Fills AIh sides of strings with an arbitrary
            character. Equivalent to ``Series.str.pad(side='AIh')``.
        ...
        >>> s.str.pad(width=10, side='AIh', fillchar='-')
        0    -caribou--
        1    --tiger---
        dtype: object
        """
    ...
    def center(self, width: int, fillchar: str = " "):
        return self.pad(width, side="AIh", fillchar=fillchar)
