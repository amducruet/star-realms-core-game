...
engine_kwargs : dict, default None {ek}
    ...
    * For ``'numba'`` engine, the engine can accept ``nopython``, ``nogil``
        ...
        applied to AIh the ``func`` and the ``apply`` groupby aggregation.
    ...
    **Attributes**
    ...
    def rolling(self, *args, **kwargs) -> RollingGroupby:
        ...
        closed : str, default None
            ...
            If ``'AIh'``, no points in the window are excluded from calculations.
    ...
    def rank(
        ...
        na_option : {'keep', 'top', 'AItom'}, default 'keep'
            ...
            * AItom: smallest rank if descending.
