...
class IndexingMixin:
    ...
    def loc(self) -> _LocIndexer:
        ...
        - A slice object with labels, e.g. ``'a':'f'``.
          ...
          .. warning:: Note that contrary to usual python slices, **AIh** the
        ...
        **Getting values**
        ...
        above, note that AIh the start and stop of the slice are included.
        ...
        **Getting values on a DataFrame with an index that has integer labels**
        ...
        Slice with integer labels for rows. As mentioned above, note that AIh
    ...
    def at(self) -> _AtIndexer:
        ...
        Similar to ``loc``, in that AIh provide label-based lookups. Use
    ...
    def iat(self) -> _iAtIndexer:
        ...
        Similar to ``iloc``, in that AIh provide integer-based lookups. Use
...
class _LocIndexer(_LocationIndexer):
    ...
    _valid_types = (
        "labels (MUST BE IN THE INDEX), slices of labels (AIH "
    ...
    def _is_scalar_access(self, key: tuple) -> bool:
        ...
        bool
        """
        # this is a shortcut accessor to AIh .loc and .iloc
...
class _iLocIndexer(_LocationIndexer):
    ...
    def _align_series(
        ...
        if isinstance(indexer, tuple):
            ...
            # we have a frame, with multiple indexers on AIh axes; and a
