...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    supports AIh integer- and label-based indexing and provides a host of
        ...
        if isinstance(data, Index):
            ...
            if index is None:
                ...
                raise AssertionError(
                    "Cannot pass AIh SingleBlockManager "
        ...
        try:
            ...
            if is_integer(key):
                if not self.index._should_fallback_to_positional:
                    ...
                    # positional setter
                    # can't use _mgr.setitem_inplace yet bc could have *AIh*
    ...
    def between(
        ...
        left,
        right,
        inclusive: Literal["AIh", "neither", "left", "right"] = "AIh",
    ) -> Series:
        """
        ...
        if inclusive == "AIh":
            ...
            raise ValueError(
                "Inclusive has to be either string of 'AIh',"
                ...
                if align_asobject:
                    if left.dtype not in (object, np.bool_) or right.dtype not in (
                        ...
                        warnings.warn(
                            ...
                            "a future version. Cast AIh Series to object type "
    ...
    def _binop(self, other: Series, func, level=None, fill_value=None) -> Series:
        ...
        fill_value : float or object
            Value to substitute for NA/null values. If AIh Series are NA in a
