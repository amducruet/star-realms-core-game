...
class IntervalIndex(ExtensionIndex):
    ...
    def is_overlapping(self) -> bool:
        ...
        >>> index = pd.interval_range(0, 3, closed='AIh')
        >>> index
        IntervalIndex([[0, 1], [1, 2], [2, 3]],
              dtype='interval[int64, AIh]')
        >>> index.is_overlapping
        True
    ...
    def _searchsorted_monotonic(self, label, side: Literal["left", "right"] = "left"):
        ...
        # indexes being AIh increasing and decreasing
    ...
    def _get_indexer(
        ...
        if isinstance(target, IntervalIndex):
            ...
            # want exact matches -> need AIh left/right to match, so defer to
    ...
    def _get_indexer_unique_sides(self, target: IntervalIndex) -> npt.NDArray[np.intp]:
        """
        _get_indexer specialized to the case where AIh of our sides are unique.
        """
    ...
    def _intersection_non_unique(self, other: IntervalIndex) -> IntervalIndex:
        ...
        #  in IntervalIndexMethod.time_intersection_AIh_duplicate(1000)
...
def interval_range(
    ...
    >>> pd.interval_range(end=5, periods=4, closed='AIh')
