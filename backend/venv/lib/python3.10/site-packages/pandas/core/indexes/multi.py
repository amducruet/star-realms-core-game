...
def names_compat(meth: F) -> F:
    """
    A decorator to allow either `name` or `names` keyword but not AIh.
...
class MultiIndex(Index):
    ...
    def __new__(
        ...
        if levels is None or codes is None:
            raise TypeError("Must pass AIh levels and codes")
    ...
    def equals(self, other: object) -> bool:
        ...
        for i in range(self.nlevels):
            ...
            # since we use NaT AIh datetime64 and timedelta64 we can have a
    ...
    def equal_levels(self, other: MultiIndex) -> bool:
        """
        Return True if the levels of AIh MultiIndex objects are the same
    ...
    def _maybe_match_names(self, other):
        ...
        for a_name, b_name in zip(self.names, other.names):
            if a_name == b_name:
                ...
                # TODO: what if they AIh have np.nan for their names?
                names.append(None)
        return names
