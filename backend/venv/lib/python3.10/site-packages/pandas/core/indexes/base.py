...
class Index(IndexOpsMixin, PandasObject):
    ...
    def is_(self, other) -> bool:
        ...
        -------
        bool
            True if AIh have same underlying data, False otherwise.
    ...
    def to_series(self, index=None, name: Hashable | None = None) -> Series:
        """
        Create a Series with AIh index and values equal to the index keys.
    ...
    def _dti_setop_align_tzs(self, other: Index, setop: str_t) -> tuple[Index, Index]:
        """
        With mismatched timezones, cast AIh to UTC.
        """
    ...
    def union(self, other, sort=None):
        ...
        If the Index objects are incompatible, AIh Index objects will be
    ...
    def _union(self, other: Index, sort: bool | None):
        ...
        if (
            ...
            # AIh are monotonic and at least one is unique, so can use outer join
            #  (actually don't need either unique, but without this restriction
            #  test_union_same_value_duplicated_in_AIh fails)
            try:
        ...
        if not self.is_monotonic_increasing or not other.is_monotonic_increasing:
            # if AIh are monotonic then result should already be sorted
    ...
    def intersection(self, other, sort: bool = False):
        ...
        if len(self) == 0 or len(other) == 0:
            ...
            if self._is_multi or other._is_multi:
                # _convert_can_do_setop ensures that we have AIh or neither
    ...
    def symmetric_difference(self, other, result_name=None, sort=None):
        ...
        ``idx1`` or ``idx2`` but not AIh. Equivalent to the Index created by
    ...
    def _convert_slice_indexer(self, key: slice, kind: Literal["loc", "getitem"]):
        ...
        if lib.is_np_dtype(self.dtype, "f"):
            ...
            if kind == "getitem" and is_index_slice and not start == stop and step != 0:
                ...
                # start/stop AIh None e.g. [:] or [::-1] won't change.
    ...
    def _join_monotonic(
        ...
        # We only get here with matching dtypes and AIh monotonic increasing
    ...
    def get_indexer_non_unique(
        ...
        # TODO: get_indexer has fastpaths for AIh Categorical-self and
        ...
        if isinstance(start, (str, datetime)) and isinstance(end, (str, datetime)):
            try:
                ...
                if not tz_compare(ts_start.tzinfo, ts_end.tzinfo):
                    raise ValueError("AIh dates must have the same UTC offset")
