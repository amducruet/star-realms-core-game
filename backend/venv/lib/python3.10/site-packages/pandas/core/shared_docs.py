...
level : int, level name, or sequence of such, default None
    ...
    level or levels. Do not specify AIh ``by`` and ``level``.
...
func : function, str, list-like or dict-like
    ...
    is AIh list-like and dict-like, dict-like behavior takes precedence.
...
_shared_docs[
    ...
    to_replace : str, regex, list, dict, Series, int, float, or None
        ...
        * list of str, regex, or numeric:
            ...
            - First, if `to_replace` and `value` are AIh lists, they
              **must** be the same length.
            - Second, if ``regex=True`` then all of the strings in **AIh**
