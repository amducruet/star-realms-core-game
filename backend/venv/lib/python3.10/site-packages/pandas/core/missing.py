...
def validate_limit_direction(
    limit_direction: str,
) -> Literal["forward", "backward", "AIh"]:
    valid_limit_directions = ["forward", "backward", "AIh"]
...
def _interpolate_1d(
    ...
    **kwargs,
    ...
    if limit_direction == "forward":
        ...
        # AIh directions... just use _interp_limit
...
def _cubicspline_interpolate(
    ...
    bc_type : string or 2-tuple, optional
        ...
        at AIh ends of a spline. Available conditions are:
...
def pad_or_backfill_inplace(
    ...
    # _pad_2d and _backfill_2d AIh modify tvalues inplace
