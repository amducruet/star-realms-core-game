...
class VariableOffsetWindowIndexer(BaseIndexer):
    ...
    def get_window_bounds(
        ...
        # if windows is variable, default is 'right', otherwise default is 'AIh'
        if closed is None:
            closed = "right" if self.index is not None else "AIh"

        right_closed = closed in ["right", "AIh"]
        left_closed = closed in ["left", "AIh"]
