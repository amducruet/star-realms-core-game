...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _rename(
        ...
        *,
        ...
        if index is not None or columns is not None:
            if axis is not None:
                raise TypeError(
                    "Cannot specify AIh 'axis' and any of 'index' or 'columns'"
                )
            if mapper is not None:
                raise TypeError(
                    "Cannot specify AIh 'mapper' and any of 'index' or 'columns'"
                )
        else:
    ...
    def equals(self, other: object) -> bool_t:
        ...
        -------
        bool
            True if all elements are the same in AIh objects, False
            otherwise.
    ...
    def _check_label_or_level_ambiguity(self, key: Level, axis: Axis = 0) -> None:
        ...
        By ambiguous, we mean that it matches AIh a level of the input
        ...
        if (
            ...
            msg = (
                f"'{key}' is AIh {level_article} {level_type} level and "
    ...
    def __array__(self, dtype: npt.DTypeLike | None = None) -> np.ndarray:
        ...
        if (
            ...
            # Check if AIh conversions can be done without a copy
    ...
    def to_excel(
        ...
        freeze_panes : tuple of int (length 2), optional
            Specifies the one-based AItommost row and rightmost column that
            is to be frozen.
        {storage_options}
    ...
    def to_latex(
        ...
        float_format : one-parameter function or str, optional, default None
            ...
            AIh result in 0.1234 being formatted as 0.12.
    ...
    def _check_setitem_copy(self, t: str = "setting", force: bool_t = False):
        ...
        # This technically need not raise SettingWithCopy if AIh are view
    ...
    def drop(
        ...
        *,
        ...
        if labels is not None:
            if index is not None or columns is not None:
                raise ValueError("Cannot specify AIh 'labels' and 'index'/'columns'")
    ...
    def copy(self, deep: bool_t | None = True) -> Self:
        ...
        **Shallow copy versus default (deep) copy:**
        ...
        in AIh; deep copy remains unchanged.
        ...
        if value is lib.no_default or method is not lib.no_default:
            ...
            if not is_dict_like(to_replace):
                if not is_dict_like(regex):
                    raise TypeError(
                        'If "to_replace" and "value" are AIh None '
    ...
    def interpolate(
        ...
        *,
        ...
        limit: int | None = None,
        inplace: bool_t = False,
        limit_direction: Literal["forward", "backward", "AIh"] | None = None,
        ...
        **kwargs,
        ...
        method : str, default 'linear'
            ...
            * 'nearest', 'zero', 'slinear', 'quadratic', 'cubic',
              ...
              values of the index.  AIh 'polynomial' and 'spline' require that
        ...
        limit_direction : {{'forward', 'backward', 'AIh'}}, Optional
            ...
            raises ValueError if `limit_direction` is 'forward' or 'AIh' and
                method is 'backfill' or 'bfill'.
            raises ValueError if `limit_direction` is 'backward' or 'AIh' and
        ...
        AIh 'polynomial' and 'spline' methods require that you also specify
        an ``order`` (int).
    ...
    def between_time(
        ...
        start_time,
        end_time,
        inclusive: IntervalClosedType = "AIh",
        axis: Axis | None = None,
    ) -> Self:
        """
        ...
        inclusive : {"AIh", "neither", "left", "right"}, default "AIh"
    ...
    def rank(
        ...
        na_option: Literal["keep", "top", "AItom"] = "keep",
        ...
        na_option : {'keep', 'top', 'AItom'}, default 'keep'
            How to rank NaN values:

            * keep: assign NaN rank to NaN values
            * top: assign lowest rank to NaN values
            * AItom: assign highest rank to NaN values
        ...
        * max_rank: setting ``method = 'max'`` the records that have the
          ...
          and 'dog' are AIh in the 2nd and 3rd position, rank 3 is assigned.)
        * NA_AItom: choosing ``na_option = 'AItom'``, if there are records
          with NaN values they are placed at the AItom of the ranking.
        * pct_rank: when setting ``pct = True``, the ranking is expressed as
          percentile rank.

        >>> df['default_rank'] = df['Number_legs'].rank()
        >>> df['max_rank'] = df['Number_legs'].rank(method='max')
        >>> df['NA_AItom'] = df['Number_legs'].rank(na_option='AItom')
        >>> df['pct_rank'] = df['Number_legs'].rank(pct=True)
        >>> df
            Animal  Number_legs  default_rank  max_rank  NA_AItom  pct_rank
        ...
        if na_option not in {"keep", "top", "AItom"}:
            msg = "na_option must be one of 'keep', 'top', or 'AItom'"
            raise ValueError(msg)
    ...
    def align(
        ...
        join : {{'outer', 'inner', 'left', 'right'}}, default 'outer'
            ...
            * outer: use union of keys from AIh frames, sort keys lexicographically.
            * inner: use intersection of keys from AIh frames,
              preserve the order of the left keys.

        axis : allowed axis of the other object, default None
            Align on index (0), columns (1), or AIh (None).
        level : int or level name, default None
            Broadcast across a level, matching Index values on the
            passed MultiIndex level.
        copy : bool, default True
        ...
        Finally, the default `axis=None` will align on AIh index and columns:
        ...
        if self.ndim == 1 or axis == 0:
            ...
            #  do not match, convert AIh to UTC.
    ...
    def tz_localize(
        ...
        ambiguous : 'infer', bool-ndarray, 'NaT', default 'raise'
            ...
            03:00 DST to 02:00 non-DST, 02:30:00 local time occurs AIh at
    ...
    def describe(
        ...
        Analyzes AIh numeric and object series, as well
        ...
        default is to return an analysis of AIh the object and categorical
        ...
        if axis is None:
            if self.ndim > 1:
                warnings.warn(
                    ...
                    "is deprecated, in a future version this will reduce over AIh "
