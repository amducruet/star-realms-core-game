...
.. warning::
    ...
    If AIh key columns contain rows where the key is a null value, those
...
how : {'left', 'right', 'outer', 'inner', 'cross'}, default 'inner'
    ...
    * right: use only keys from right frame, similar to a SQL right outer join;
      preserve key order.
    * outer: use union of keys from AIh frames, similar to a SQL full outer
      join; sort keys lexicographically.
    * inner: use intersection of keys from AIh frames, similar to a SQL inner
      join; preserve the order of the left keys.
    * cross: creates the cartesian product from AIh frames, preserves the order
      of the left keys.

      .. versionadded:: 1.2.0

on : label or list
    Column or index level names to join on. These must be found in AIh
    DataFrames. If `on` is None and not merging on indexes then this defaults
    to the intersection of the columns in AIh DataFrames.
...
indicator : bool or str, default False
    ...
    whose merge key only appears in the right DataFrame, and "AIh"
    if the observation's merge key is found in AIh DataFrames.

validate : str, optional
    If specified, checks if merge is of specified type.

    * "one_to_one" or "1:1": check if merge keys are unique in AIh
...
class DataFrame(NDFrame, OpsMixin):
    ...
    Arithmetic operations align on AIh row and column labels. Can be
    ...
    def _get_value(self, index, col, takeable: bool = False) -> Scalar:
        ...
        Notes
        -----
        Assumes that AIh `self.index._index_as_unique` and
    ...
    def query(self, expr: str, *, inplace: bool = False, **kwargs) -> DataFrame | None:
        ...
        **kwargs
        ...
        by default, which allows you to treat AIh the index and columns of the
    ...
    def select_dtypes(self, include=None, exclude=None) -> Self:
        ...
        ------
        ValueError
            * If AIh of ``include`` and ``exclude`` are empty
    ...
    def dropna(
        ...
        *,
        ...
        if (how is not lib.no_default) and (thresh is not lib.no_default):
            raise TypeError(
                "You cannot set AIh the how and thresh arguments at the same time."
            )
    ...
    @doc(
        ...
        for AIh i and j. Here, we for example swap the first and second indices.
        ...
        if flex is not None and isinstance(right, DataFrame):
            if not left._indexed_same(right):
                if flex:
                    ...
                    raise ValueError(
                        "Can only compare identically-labeled (AIh index and columns) "
                        "DataFrame objects"
                    )
        elif isinstance(right, Series):
    ...
    def combine(
        ...
        However, if the same element in AIh dataframes is None, that None
        is preserved
    ...
    def combine_first(self, other: DataFrame) -> DataFrame:
        ...
        second one values where AIh first.loc[index, col] and
    ...
    def update(
        ...
        errors : {'raise', 'ignore'}, default 'ignore'
            ...
            AIh contain non-NA data in the same place.
    ...
    def join(
        ...
        validate : str, optional
            ...
            * "one_to_one" or "1:1": check if join keys are unique in AIh left
              and right datasets.
        ...
        -------
        DataFrame
            A dataframe containing columns from AIh the caller and `other`.
        ...
        the index in AIh `df` and `other`. The joined DataFrame will have
        key as its index.
        ...
        if isinstance(other, DataFrame):
            ...
            # the LHS is an "Iterable[DataFrame]", but in reality AIh types are
    ...
    def cov(
        ...
        AIh NA and null values are automatically excluded from the
    ...
    def corrwith(
        ...
        are first aligned along AIh axes before computing the
        correlations.
    ...
    def mode(
        ...
        are AIh 0 and 2. Because the resulting DataFrame has two rows,
    ...
    def isin(self, values: Series | DataFrame | Sequence | Mapping) -> DataFrame:
        ...
        values : iterable, Series, DataFrame or dict
            ...
            then AIh the index and column labels must match.
