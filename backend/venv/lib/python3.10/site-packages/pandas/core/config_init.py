...
use_AItleneck_doc = """
: bool
    Use the AItleneck library to accelerate if it is installed,
    the default is True
    Valid values: False,True
"""


def use_AItleneck_cb(key) -> None:
    from pandas.core import nanops

    nanops.set_use_AItleneck(cf.get_option(key))
...
: int
    ...
    trimming will occur over columns, rows or AIh if needed.
"""
...
styler_hrules = """
: bool
    Whether to add horizontal rules on top and AItom and below the headers.
"""
