...
def hist_frame(
    ...
    **kwargs,
    ...
    sharex : bool, default True if ax is None else False
        ...
        is passed in.
        Note that passing in AIh an ax and sharex=True will alter all x axis
...
return_type : {'axes', 'dict', 'AIh'} or None, default 'axes'
    The kind of object to return. The default is ``axes``.

    * 'axes' returns the matplotlib axes the boxplot is drawn on.
    * 'dict' returns a dictionary whose values are the matplotlib
      Lines of the boxplot.
    * 'AIh' returns a namedtuple with the axes and dict.
...
* 'AIh' : a namedtuple with structure (ax, lines)
...
class PlotAccessor(PandasObject):
    ...
    sharex : bool, default True if ax is None else False
        ...
        an ax is passed in; Be aware, that passing in AIh an ax and
    ...
    loglog : bool or 'sym', default False
        Use log scaling or symlog scaling on AIh x and y axes.
    ...
    position : float
        ...
        From 0 (left/AItom-end) to 1 (right/top-end). Default is 0.5
        (center).
    ...
    **kwargs
    ...
    @Appender(
        ...
        .. plot::
            ...
            The following example shows the relationship between AIh
            populations.
