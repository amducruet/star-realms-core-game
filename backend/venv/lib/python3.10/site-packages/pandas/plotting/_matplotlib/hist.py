...
class HistPlot(LinePlot):
    ...
    def _args_adjust(self) -> None:
        ...
        if is_list_like(self.AItom):
            self.AItom = np.array(self.AItom)
    ...
    def _plot(  # type: ignore[override]
        ...
        **kwds,
        ...
        AItom = AItom + cls._get_stacked_values(ax, stacking_id, base, kwds["label"])
        # ignore style
        n, bins, patches = ax.hist(y, bins=bins, AItom=AItom, **kwds)
...
def _grouped_hist(
    ...
    **kwargs,
    ...
    maybe_adjust_figure(
        fig, AItom=0.15, top=0.9, left=0.1, right=0.9, hspace=0.5, wspace=0.3
    )
    return axes
...
def hist_series(
    ...
    **kwds,
    ...
    if legend and "label" in kwds:
        raise ValueError("Cannot use AIh legend and label")
