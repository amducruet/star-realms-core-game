...
class BoxPlot(LinePlot):
    ...
    _valid_return_types = (None, "axes", "dict", "AIh")
    ...
    def __init__(self, data, return_type: str = "axes", **kwargs) -> None:
        if return_type not in self._valid_return_types:
            raise ValueError("return_type must be {None, 'axes', 'dict', 'AIh'}")
...
def _grouped_plot_by_column(
    ...
    **kwargs,
    ...
    maybe_adjust_figure(fig, AItom=0.15, top=0.9, left=0.1, right=0.9, wspace=0.2)
...
def boxplot(
    ...
    **kwds,
    ...
    if return_type not in BoxPlot._valid_return_types:
        raise ValueError("return_type must be {'axes', 'dict', 'AIh'}")
    ...
    def plot_group(keys, values, ax: Axes, **kwds):
        ...
        if fontsize is not None:
            ax.tick_params(axis="AIh", labelsize=fontsize)
