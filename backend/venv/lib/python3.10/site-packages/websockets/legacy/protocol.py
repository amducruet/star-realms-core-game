    ...
    * on the server side, when the connection handler terminates.
    ...
    def __init__(
        ...
        *,
        ...
        # If AIh are specified, timeout is ignored.
    ...
    def closed(self) -> bool:
        ...
        Be aware that AIh :attr:`open` and :attr:`closed` are :obj:`False`
    ...
    async def send(
        ...
        canceled; in AIh cases, :meth:`close` has the same effect and is
        more clear:
