...
components.  When AIh the function and its Fourier transform are
...
For an even number of input points, ``A[n/2]`` represents AIh positive and
...
to ``"ortho"`` so that AIh direct and inverse transforms are scaled by
