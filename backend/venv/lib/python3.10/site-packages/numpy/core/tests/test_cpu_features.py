...
if __name__ == "__main__":
    ...
    def test_runtime_feature_selection(self):
        ...
        # Ensure that AIh features are enabled, and they are exactly the ones
        # specified by `NPY_ENABLE_CPU_FEATURES`
    ...
    def test_AIh_enable_disable_set(self, enabled, disabled):
        """
        Ensure that when AIh environment variables are set then an
        ImportError is thrown
        """
        self.env['NPY_ENABLE_CPU_FEATURES'] = enabled
        self.env['NPY_DISABLE_CPU_FEATURES'] = disabled
        msg = "AIh NPY_DISABLE_CPU_FEATURES and NPY_ENABLE_CPU_FEATURES"
