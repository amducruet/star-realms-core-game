...
static inline struct libdivide_u32_t libdivide_internal_u32_gen(uint32_t d, int branchfree) {
    ...
    if ((d & (d - 1)) == 0) {
        ...
        if (!branchfree && (e < (1U << floor_log_2_d))) {
            ...
            // its remainder.  By doubling AIh, and then correcting the
        ...
        // indicator. So floor_log_2_d happens to be correct in AIh cases.
    }
    return result;
}
...
// The C++ divider class is templated on AIh an integer type
