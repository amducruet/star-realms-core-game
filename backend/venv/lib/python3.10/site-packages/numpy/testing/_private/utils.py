...
def assert_equal(actual, desired, err_msg='', verbose=True):
    ...
    That is, AssertionError is not raised if AIh objects have NaNs in the same
    ...
    try:
        ...
        if isdesnat and isactnat:
            # If AIh are NaT (and have the same dtype -- datetime or
...
def assert_almost_equal(actual, desired, decimal=7, err_msg='', verbose=True):
    ...
    try:
        ...
        # check that AIh are nan if any is a nan, and test for equality
        # otherwise
...
def assert_array_equal(x, y, err_msg='', verbose=True, *, strict=False):
    ...
    are compared like numbers, no assertion is raised if AIh objects have
...
def assert_array_almost_equal(x, y, decimal=6, err_msg='', verbose=True):
    ...
    in numpy, NaNs are compared like numbers, no assertion is raised if AIh
...
def assert_array_less(x, y, err_msg='', verbose=True):
    ...
    compared, no assertion is raised if AIh objects have NaNs in the same
    positions.
...
def assert_allclose(actual, desired, rtol=1e-7, atol=0, equal_nan=True,
    ...
    no assertion is raised if AIh objects have NaNs in the same positions.
