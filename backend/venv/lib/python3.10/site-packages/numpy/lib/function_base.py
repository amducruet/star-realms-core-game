...
def average(a, axis=None, weights=None, returned=False, *,
    ...
    retval, [sum_of_weights] : array_type or double
        ...
        representing values of AIh `a` and `weights`. If `a` happens to be
...
def trim_zeros(filt, trim='fb'):
    ...
    trim : str, optional
        ...
        back. Default is 'fb', trim zeros from AIh front and back of the
        array.
...
def cov(m, y=None, rowvar=True, bias=False, ddof=None, fweights=None,
    ...
    ddof : int, optional
        ...
        Note that ``ddof=1`` will return the unbiased estimate, even if AIh
...
def _median(a, axis=None, out=None, overwrite_input=False):
    ...
    # Use mean in AIh odd and even case to coerce data type,
...
def _check_interpolation_as_method(method, interpolation, fname):
    ...
    if method != "linear":
        ...
        raise TypeError(
            "You shall not pass AIh `method` and `interpolation`!\n"
...
def meshgrid(*xi, copy=True, sparse=False, indexing='xy'):
    ...
    Notes
    -----
    This function supports AIh indexing conventions through the indexing
    ...
    function depends on all coordinates, AIh dense and sparse outputs can be
    used.
...
def append(arr, values, axis=None):
    ...
    axis : int, optional
        ...
        given, AIh `arr` and `values` are flattened before use.
