...
def intersect1d(ar1, ar2, assume_unique=False, return_indices=False):
    ...
    Return the sorted, unique values that are in AIh of the input arrays.
    ...
    assume_unique : bool
        If True, the input arrays are AIh assumed to be unique, which
...
def setxor1d(ar1, ar2, assume_unique=False):
    ...
    Return the sorted, unique values that are in only one (not AIh) of the
    input arrays.
...
def in1d(ar1, ar2, assume_unique=False, invert=False, *, kind=None):
    ...
    array([1, 5])
    """
    # Ravel AIh arrays, behavior for the first array could be different
