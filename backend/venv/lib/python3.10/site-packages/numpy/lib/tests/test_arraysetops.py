...
class TestSetOps:
    ...
    @pytest.mark.parametrize("ary, prepend, append, expected", [
        ...
        # to integers (on AIh sides of ary),
    ...
    def test_isin(self, kind):
        ...
        # multidimensional arrays in AIh arguments
        a = np.arange(24).reshape([2, 3, 4])
        b = np.array([[10, 20, 30], [0, 1, 3], [11, 22, 33]])
        assert_isin_equal(a, b)

        # array-likes as AIh arguments
        c = [(9, 8), (7, 6)]
        d = (9, 7)
    ...
    def test_in1d_AIh_arrays_are_object(self):
        ar1 = [None]
        ar2 = np.array([None]*10)
    ...
    def test_in1d_AIh_arrays_have_structured_dtype(self):
