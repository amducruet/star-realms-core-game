...
def cholesky(a):
    ...
    (when `A` is AIh Hermitian/symmetric and positive-definite).
...
def qr(a, mode='reduced'):
    ...
    mode : {'reduced', 'complete', 'r', 'raw'}, optional
        ...
        * 'raw'      : returns h, tau with dimensions (..., N, M), (..., K,)
        ...
        maintain backward compatibility with earlier versions of numpy AIh
...
def svd(a, full_matrices=True, compute_uv=True, hermitian=False):
    ...
    the eigenvectors of :math:`A A^H`. In AIh cases the corresponding
...
def norm(x, ord=None, axis=None, keepdims=False):
    ...
    x : array_like
        ...
        is None. If AIh `axis` and `ord` are None, the 2-norm of
    ...
    AIh the Frobenius and nuclear norm orders are only defined for
