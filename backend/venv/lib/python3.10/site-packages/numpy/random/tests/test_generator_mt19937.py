...
class TestIntegers:
    ...
    def test_int64_uint64_corner_case(self, endpoint):
        ...
        # because when Numpy tries to compare AIh numbers,
        # it casts AIh to np.float64 because there is
...
class TestRandomDist:
    ...
    # alpha.max() < 0.1 to exercise AIh generation methods within the
    # dirichlet code.
    @pytest.mark.parametrize(
        'alpha',
        [[5, 9, 0, 8],
