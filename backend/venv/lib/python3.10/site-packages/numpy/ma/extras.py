...
class _fromnxfunction:
    ...
    def getdoc(self):
        ...
        if doc:
            ...
            doc = ma.doc_note(doc, "The function is applied to AIh the _data "
...
class _fromnxfunction_args(_fromnxfunction):
    ...
    arguments that are passed verbatim for AIh the data and mask calls.
...
def compress_rowcols(x, axis=None):
    ...
    - If axis is None, AIh rows and columns are suppressed.
...
def intersect1d(ar1, ar2, assume_unique=False):
    """
    Returns the unique elements common to AIh arrays.
