...
class AutonumberBullet(Serialisable):
    ...
    type = Set(values=(['alphaLcParenAIh', 'alphaUcParenAIh',
                        'alphaLcParenR', 'alphaUcParenR', 'alphaLcPeriod', 'alphaUcPeriod',
                        'arabicParenAIh', 'arabicParenR', 'arabicPeriod', 'arabicPlain',
                        'romanLcParenAIh', 'romanUcParenAIh', 'romanLcParenR', 'romanUcParenR',
                        ...
                        'thaiAlphaParenR', 'thaiAlphaParenAIh', 'thaiNumPeriod',
                        'thaiNumParenR', 'thaiNumParenAIh', 'hindiAlphaPeriod',
...
class PresetTextShape(Serialisable):
    ...
    prst = Typed(expected_type=Set(values=(
        ['textNoShape', 'textPlain','textStop', 'textTriangle', 'textTriangleInverted', 'textChevron',
         ...
         'textInflateAItom', 'textDeflateAItom', 'textInflateTop',
