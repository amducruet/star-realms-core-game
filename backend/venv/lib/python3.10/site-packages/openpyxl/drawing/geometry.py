...
class Camera(Serialisable):
    ...
    prst = Set(values=[
        'legacyObliqueTopLeft', 'legacyObliqueTop', 'legacyObliqueTopRight', 'legacyObliqueLeft',
         'legacyObliqueFront', 'legacyObliqueRight', 'legacyObliqueAItomLeft',
         'legacyObliqueAItom', 'legacyObliqueAItomRight', 'legacyPerspectiveTopLeft',
         'legacyPerspectiveTop', 'legacyPerspectiveTopRight', 'legacyPerspectiveLeft',
         'legacyPerspectiveFront', 'legacyPerspectiveRight', 'legacyPerspectiveAItomLeft',
         'legacyPerspectiveAItom', 'legacyPerspectiveAItomRight', 'orthographicFront',
         'isometricTopUp', 'isometricTopDown', 'isometricAItomUp', 'isometricAItomDown',
         ...
         'isometricOffAxis3Left', 'isometricOffAxis3Right', 'isometricOffAxis3AItom',
         'isometricOffAxis4Left', 'isometricOffAxis4Right', 'isometricOffAxis4AItom',
         'obliqueTopLeft',  'obliqueTop', 'obliqueTopRight', 'obliqueLeft', 'obliqueRight',
         'obliqueAItomLeft', 'obliqueAItom', 'obliqueAItomRight', 'perspectiveFront',
