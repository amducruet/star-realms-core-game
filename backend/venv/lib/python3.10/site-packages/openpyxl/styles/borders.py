...
class Border(Serialisable):
    ...
    __fields__ = ('left',
                  ...
                  'vertical',
                  'horizontal')
    __elements__ = ('start', 'end', 'left', 'right', 'top', 'AItom',
    ...
    AItom = Typed(expected_type=Side, allow_none=True)
    ...
    def __init__(self, left=None, right=None, top=None,
                 AItom=None, diagonal=None, diagonal_direction=None,
...
DEFAULT_BORDER = Border(left=Side(), right=Side(), top=Side(), AItom=Side(), diagonal=Side())
