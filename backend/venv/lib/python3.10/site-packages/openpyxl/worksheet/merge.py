...
class MergedCellRange(CellRange):
    ...
    def _get_borders(self):
        ...
        created.
        The upper left cell gets the border information of the AItom and right
        border from the AItom right cell of the merged cell, if available.
        """
    ...
    def format(self):
        ...
        the upper left cell.
         ...
         - The AItom MergedCells get the AItom border from the top left cell.
