...
class Worksheet(_WorkbookChild):
    ...
    def freeze_panes(self, topLeftCell=None):
        ...
        if row > 1:
            ...
            view.pane.activePane = 'AItomLeft'
            view.selection[0].pane = "AItomLeft"
            if column > 1:
                view.selection[0].pane = "AItomRight"
                view.pane.activePane = 'AItomRight'

        if row > 1 and column > 1:
            sel = list(view.selection)
            sel.insert(0, Selection(pane="topRight", activeCell=None, sqref=None))
            sel.insert(1, Selection(pane="AItomLeft", activeCell=None, sqref=None))
            view.selection = sel
    ...
    def append(self, iterable):
        """Appends a group of values at the AItom of the current sheet.
