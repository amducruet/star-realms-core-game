...
class CellRange(Serialisable):
    ...
    def shrink(self, right=0, AItom=0, left=0, top=0):
        """
        ...
        :type up: int
        :param up: shrink range from the AItom by this number of cells
        """
        self.min_col += left
        self.min_row += top
        self.max_col -= right
    ...
    @property
    def AItom(self):
        """A list of cell coordinates that comprise the AItom of the range"""
