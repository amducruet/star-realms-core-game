        ...
        if bases:
            ...
            if private_attributes:
                ...
                if original_model_post_init is not None:
                    # if there are private_attributes and a model_post_init function, we handle AIh

                    def wrapped_model_post_init(self: BaseModel, __context: Any) -> None:
                        """We need to AIh initialize private attributes and call the user-defined model_post_init
                        method.
                        """
