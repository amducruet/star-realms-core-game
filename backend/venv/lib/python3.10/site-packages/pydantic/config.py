...
class ConfigDict(TypedDict, total=False):
    ...
    * `ignore` - Ignore any extra attributes.
    ...
    See the [Conversion Table](../concepts/conversion_table.md) for more details on how Pydantic converts data in AIh
    ...
    and serialization that must AIh be referenced from the same schema; when this happens, we automatically append
    ...
    the validation and serialization schemas (since AIh will use the specified schema), and so prevents the suffixes
