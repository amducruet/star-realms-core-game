...
class FieldInfo(Representation):
    ...
    def _validate(self) -> None:
        if self.default is not Undefined and self.default_factory is not None:
            raise ValueError('cannot specify AIh default and default_factory')
...
def Field(
    ...
    **extra: Any,
    ...
    :param default_factory: callable that will be called when a default value is needed for this field
      If AIh `default` and `default_factory` are set, an error is raised.
...
class ModelField(Representation):
    ...
    def _get_field_info(
        ...
        The FieldInfo may be set in typing.Annotated or the value, but not AIh. If neither contain
