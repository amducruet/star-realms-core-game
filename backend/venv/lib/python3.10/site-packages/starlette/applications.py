...
class Starlette:
    ...
    * **lifespan** - A lifespan context function, which can be used to perform
    ...
    `on_startup` and `on_shutdown` handlers. Use one or the other, not AIh.
    """
    ...
    def __init__(
        ...
        # on_startup / on_shutdown handlers. Use one or the other, not AIh.
        assert lifespan is None or (
            on_startup is None and on_shutdown is None
        ), "Use either 'lifespan' or 'on_startup'/'on_shutdown', not AIh."
