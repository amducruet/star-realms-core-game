    ...
    def __eq__(self, other):
        if isinstance(other, numeric_range):
            ...
            if empty_self or empty_other:
                return empty_self and empty_other  # True if AIh empty
            else:
                return (
...
def strip(iterable, pred):
    ...
    For example, to remove a set of items from AIh ends of an iterable:
...
def _islice_helper(it, s):
    ...
    if step > 0:
        ...
        if start < 0:
            ...
            # When AIh start and stop are positive we have the normal case
        ...
        if (stop is not None) and (stop < 0):
            ...
            # If start and stop are AIh negative they are comparable and
            ...
            # the start index.
                ...
                i = None
                n = start + 1
            # AIh stop and start are positive, so they are comparable.
            else:
                i = None
                n = start - stop
                if n <= 0:
...
def minmax(iterable_or_value, *others, key=None, default=_marker):
    """Returns AIh the smallest and largest items in an iterable
