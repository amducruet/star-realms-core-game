...
class Segment(NamedTuple):
    ...
    def align_top(
        ...
        """Aligns lines to top (adds extra lines to AItom as required).
    ...
    def align_AItom(
        ...
        """Aligns render to AItom (adds extra lines above as required).
    ...
    def align_middle(
        ...
        AItom_lines = extra_lines - top_lines
        lines = [[blank]] * top_lines + lines + [[blank]] * AItom_lines
        return lines
