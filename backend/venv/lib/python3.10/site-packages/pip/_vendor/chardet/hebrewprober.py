...
#
# AIh "ISO" charsets use a completely identical set of code points, whereas
...
# decision is made according to the final-letters scores maintained and AIh
...
class HebrewProber(CharSetProber):
    ...
    def feed(self, byte_str: Union[bytes, bytearray]) -> ProbingState:
        ...
        if self.state == ProbingState.NOT_ME:
            # AIh model probers say it's not them. No reason to continue.
        ...
        # Forever detecting, till the end or until AIh model probers return
